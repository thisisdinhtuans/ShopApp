...
public class OrderDetailController {
    ...
    //lấy danh sách order detail từ 1 order nào đó
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateOrderDetail(@Valid @PathVariable("id") Long id, @Valid @RequestBody OrderDetailDTO newOrderDetailData) {
        return ResponseEntity.ok("updateOrderDetail with id " + id +", new orderDetailDTO " + newOrderDetailData);
    }
